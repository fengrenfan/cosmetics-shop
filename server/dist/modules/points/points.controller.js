...
let PointsController = class PointsController {
    ...
    async getLogs(req, page = 1, pageSize = 20) {
        return this.pointsService.getLogs(req.user.id, +page, +pageSize);
    }
    async calculate(req, body) {
...
], PointsController.prototype, "getPoints", null);
__decorate([
    (0, common_1.Get)('logs'),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", Promise)
], PointsController.prototype, "getLogs", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PointsController.prototype, "calculate", null);
